...
import 'package:graduation_project/features/user/presentation/tabs/pharmacie_tab/pharmacy_list/controller/pharmacy_details_cubit.dart';
              ...
              if (state is PharmacyDetailsLoading) {
                ...
                return Column(
                  children: [
                    Stack(
                      children: [
                        Image.network(pharmacy.imageURL ?? 'https://www.iisertvm.ac.in/assets/images/placeholder.jpg', width: double.infinity, fit: BoxFit.cover),
                        IconButton(
                          onPressed: () {
