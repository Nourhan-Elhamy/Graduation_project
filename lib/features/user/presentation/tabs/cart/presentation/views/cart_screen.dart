                    ...
                    children: [
                            ...
                            return Card(
                              child: ListTile(
                                ...
                                trailing: Row(
                                  ...
                                  children: [
                                    Text(item.medicine.price,style: TextStyle(fontSize: 20),),
                                    IconButton(
                                      icon: Icon(Icons.delete_outline, color: Colors.red),
                                      onPressed: () {
                                        context.read<CartCubit>().deleteFromCart(item.medicine.id); // هنا ID العنصر في السلة
                                      },
                                    ),
                                  ],
                                ),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text('${cart.totalPrice + 20} EGP', style: const TextStyle(fontWeight: FontWeight.bold)),
                        ],
                      ),
                      const SizedBox(height: 16),
                      SizedBox(
                        width: double.infinity,
                        child:CustomButton(title: "Checkout", color: AppColors.blue, textcolor: AppColors.white,
                          onPressed: (){
